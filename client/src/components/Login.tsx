      ...
      >
        <div className="bg-white rounded-xl shadow-xl overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-6 text-center">
            ...
            <p className="mt-1 text-blue-100">Access your administration panel</p>
          </div>
          ...
          <div className="p-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit}>
              ...
              >
                <button
                  type="submit"
                  className={`relative inline-flex items-center justify-center px-6 py-3 overflow-hidden font-bold text-white rounded-md shadow-md group bg-blue-600 hover:bg-blue-700 transition-all duration-300 w-full ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
                  disabled={isLoading}
                >
              ...
              <div className="mt-6 text-center text-sm">
                <p className="text-gray-600">
                  Use <span className="font-bold">admin@example.com</span> and password <span className="font-bold">admin123</span> to login as admin
                </p>
              </div>
            </form>
