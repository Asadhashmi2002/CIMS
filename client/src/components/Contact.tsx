          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 md:py-4">
            <div className="flex items-center justify-between">
              ...
              <nav className="hidden md:flex space-x-8 items-center">
                ...
                <Link to="/contact" className="text-blue-600 font-medium transition-colors">Contact</Link>
                <div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div>
                  <button
                    ...
                    className={`w-full inline-flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${isSubmitting ? 'opacity-75 cursor-not-allowed' : ''}`}
                  >
                    {isSubmitting ? (
                      <>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  Have questions about our services? Looking for a demo? Our team is ready to help you.
                </p>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-1 text-gray-600">info@class-entry.com</p>
                      <p className="mt-1 text-gray-600">support@class-entry.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-1 text-gray-600">+91 98765 43210 (Sales)</p>
                      <p className="mt-1 text-gray-600">+91 98765 43211 (Support)</p>
                    </div>
                  </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-800 font-medium">10:00 AM - 2:00 PM IST</span>
                  </div>
                  <div className="flex justify-between">
      ...
      <div className="py-12 sm:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden h-96">
            {/* This is a placeholder for a map - in a real app, you would integrate with Google Maps or similar */}
            <div className="h-full bg-gray-200 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-lg font-medium">Map loading...</p>
                <p className="text-gray-500">123 Education Lane, Tech Park, Bangalore</p>
              </div>
            </div>
          </div>
        </div>
